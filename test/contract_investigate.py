...
template='''
        ...
        【
            - [在这里填写你认为建议修改的第1项内容]：[在这里填写你认为该项内容存在的问题][在这里填写你认为该项内容建议修改的内容][在这里填写你认为该项内容严重程度]
...
keypoints='''
    ...
    关键问题点6.在合同服务人员急款中，服务人员是否明确	
    关键问题点7.在合同服务时间条款中，服务时间是否明确
    关键问题点8.在合同保密条款中，保密范围、保密方式、保密期限以及相应的保密责任是否明确
    关键问题点9.在合同主体条款中，合同主体信息是否完整
    关键问题点10.在合同违约责任急款中，违约责任是否完整
    关键问题点11.在合同知识产权条款中，服务成果的知识产权归属是否明确
    关键问题点12.在合同知识产权条款中，第三方知识产权是否明确
    关键问题点13.在合同知识产权条款中，对于服务成果知识产权不侵权的承诺
'''
...
content='''
    ...
    6.1.9 甲方若需要乙方提供源码技术部署服务，甲方需及时提供上线部署所需各项真实可用材料；若因甲方提供材料不及时、不完整、不可用等因素导致上线延期，甲方自行承担后果；自技术部署完成交付于甲方后，乙方不承担一切由于甲方技术维护不当或其他人为、第三方因素而导致的一切损失和责任。
