...
boss_enterprise_characteistic_identify_word=boss_enterprise_characteistic_identify.get_boss_enterprise_characteristic(boss_characteristic_identify_word,enterprise_strategic_vision_long_word)
