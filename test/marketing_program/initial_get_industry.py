...
template='''
        你是一位专业的行业判断师，我会给你一个需求，你需要理解内容并在互联网上搜索相关信息来确定这属于什么行业，并组织语言阐述给我，
        注意，你仅需要回答我行业名称即可，其他什么都不需要。    
...
def get_industry_analysis(search_content):
...
此外，中科蓝吧还特别注重数据安全与隐私保护，在其产品设计中融入了多项先进的安全措施，确保用户的数据资产得到充分保障。总之，中科蓝吧致力于成为企业数字化转型过程中值得信赖的合作伙伴。
        '''
    get_industry_analysis(search_content)
