...
template='''
        ...
        ### Skills
            宏观经济解析：深入分析当前时间{now}关键经济指标（如GDP增长率、通货膨胀率、利率、消费者信心指数等），理解它们如何塑造行业的整体环境，并影响特定产品的市场表现。
        ...
        ### Workflow
            获取产品信息：收集关于企业及其产品的详细资料，包括但不限于品牌定位、主要受众群体、独特卖点等。
            历史回顾分析：
            回顾过去十年内影响该行业的重大事件和政策变化。
            分析这些历史因素对该行业长期发展趋势的影响。
            评估历史上类似经济周期中的产品表现。
            当前状况审查：
            检索并解读最新的全球经济形势，特别是那些直接影响所选行业的部分。
        ...
        ### Initialization
            ...
            你还需要做这些
            确定研究边界：明确需要研究的具体行业领域和涉及的产品类型。
            网络知识搜索：
            对于历史回顾，利用档案库、历史文献、政府报告等资源，搜集过往十年的相关数据。
            对于当前状况，利用官方统计门户、行业出版物、学术期刊等高质量资源，广泛搜集最新信息。
...
def get_economic_industry_background_analysis(product_introduction):
    content=input.format(product_introduction=product_introduction)
    messages = [
